...
class InMemoryDatabase(DatabaseIntegration):
    ...
    def add_entity(self, entity_type: str, data: Dict[str, Any]) -> int:
        global next_id
        entity_id = next_id
    ...
    def get_all_entities(self, entity_type: str) -> Dict[int, Dict[str, Any]]:
        return self.graph["entities"].get(entity_type, {})

    def update_entity(self, entity_type: str, entity_id: int, data: Dict[str, Any]) -> bool:
    ...
    def search_entities(self, search_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        results = []
    ...
    def search_entities_with_type(self, entity_type: str, search_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        results = []
    ...
    def search_relationships(self, search_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        results = []
